  ...
  public static long part2() {
    ...
    for (int i = 0; i < passports.size(); i++) {
      ...
      if (passport.size() == 8 || passport.size() == 7 && !passport.containsKey("cid")) {
        if (!(1920 <= Integer.parseInt(passport.get("byr")) && Integer.parseInt(passport.get("byr")) <= 2002)) {
          continue;
        }
        if (!(2010 <= Integer.parseInt(passport.get("iyr")) && Integer.parseInt(passport.get("iyr")) <= 2020)) {
          continue;
        }
        if (!(2020 <= Integer.parseInt(passport.get("eyr")) && Integer.parseInt(passport.get("eyr")) <= 2030)) {
          continue;
        }
        ...
        if (!(passport.get("hcl").startsWith("#") && passport.get("hcl").split("#")[1].length() == 6 && passport.get("hcl").split("#")[1].matches("[a-f0-9]+"))) {
          continue;
        }
